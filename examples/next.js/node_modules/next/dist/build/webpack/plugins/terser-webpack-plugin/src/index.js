...
class TerserPlugin {
    constructor(options = {}) {
        const { terserOptions = {}, warningsFilter = () => true, sourceMap = false, cache = false, cpus, distDir, } = options;
        this.cpus = cpus;
    ...
    apply(compiler) {
        const optimizeFn = (compilation, chunks, callback) => {
            const taskRunner = new TaskRunner_1.default(this.distDir, this.cpus);
            ...
            Array.from(chunks)
                ...
                try {
                    ...
                    if (this.options.cache) {
                        ...
                        task.cacheKey = 'a' + string_hash_1.default(input);
