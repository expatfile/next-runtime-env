...
module.exports = babel_loader_1.default.custom(babel => {
    ...
    return {
        customOptions(opts) {
            ...
            const filename = path_1.join(opts.cwd, 'noop.js');
            const loader = Object.assign({
                cacheCompression: false,
                cacheDirectory: true,
                cacheIdentifier: cacheKey + JSON.stringify(babel.loadPartialConfig({
                    filename,
                    cwd: opts.cwd,
        ...
        config(cfg, { source, customOptions: { isServer, asyncToPromises } }) {
            ...
            if (isServer && source.indexOf('next/data') !== -1) {
                const nextDataPlugin = babel.createConfigItem([require('../../babel/plugins/next-data'), { key: path_1.basename(filename) + '-' + string_hash_1.default(filename) }], { type: 'plugin' });
