 ...
 */
var baseSetData = !metaMap ? identity$2 : function(func, data) {
...
var assignIn = createAssigner(function(object, source) {
  copyObject(source, keysIn$3(source), object);
});
...
var assignInWith = createAssigner(function(object, source, srcIndex, customizer) {
  copyObject(source, keysIn$3(source), object, customizer);
});
...
var assignWith = createAssigner(function(object, source, srcIndex, customizer) {
  copyObject(source, keys$2(source), object, customizer);
});
...
var bindAll = flatRest(function(object, methodNames) {
  arrayEach(methodNames, function(key) {
    key = toKey(key);
    baseAssignValue(object, key, bind$2(object[key], object));
  });
  return object;
});
...
function createRound(methodName) {
  ...
  return function(number, precision) {
    ...
    if (precision) {
      ...
      var pair = (toString$3(number) + 'e').split('e'),
...
function baseAssignIn(object, source) {
  return object && copyObject(source, keysIn$3(source), object);
}
 ...
 * // => { '3': 2, '5': 1 }
 */
var countBy$2 = createAggregator(function(result, value, key) {
...
function customDefaultsAssignIn(objValue, srcValue, key, object) {
  if (objValue === undefined ||
      (eq(objValue, objectProto$20[key]) && !hasOwnProperty$17.call(object, key))) {
    return srcValue;
  }
  return objValue;
}
...
function toPlainObject(value) {
  return copyObject(value, keysIn$3(value));
}
 ...
 * // => { 'a': [1, 3], 'b': [2, 4] }
 */
var mergeWith$2 = createAssigner(function(object, source, srcIndex, customizer) {
 ...
 * // => [{ 'x': 2, 'y': 1 }]
 */
var differenceWith$2 = baseRest(function(array, values) {
 ...
 * // => 1.5
 */
var divide$2 = createMathOperation(function(dividend, divisor) {
...
function baseForOwnRight(object, iteratee) {
  return object && baseForRight(object, iteratee, keys$2);
}
 ...
 */
var toPairs$2 = createToPairs(keys$2);
 ...
 */
var toPairsIn$2 = createToPairs(keysIn$3);
 ...
 * // => object for 'barney'
 */
var find$2 = createFind(findIndex$2);
 ...
 * // => 3
 */
var findLast$2 = createFind(findLastIndex$2);
...
function forIn(object, iteratee) {
  return object == null
    ? object
    : baseFor(object, castFunction(iteratee), keysIn$3);
}
...
function forInRight(object, iteratee) {
  return object == null
    ? object
    : baseForRight(object, castFunction(iteratee), keysIn$3);
}
...
function functions(object) {
  return object == null ? [] : baseFunctions(object, keys$2(object));
}
...
function functionsIn(object) {
  return object == null ? [] : baseFunctions(object, keysIn$3(object));
}
 ...
 * // => { '3': ['one', 'two'], '5': ['three'] }
 */
var groupBy$2 = createAggregator(function(result, value, key) {
 ...
 * // => false
 */
var gte$2 = createRelationalOperation(function(value, other) {
  return value >= other;
});
...
function includes(collection, value, fromIndex, guard) {
  collection = isArrayLike(collection) ? collection : values$2(collection);
 ...
 * // => [2]
 */
var intersection$2 = baseRest(function(arrays) {
 ...
 * // => { '1': 'c', '2': 'b' }
 */
var invert$2 = createInverter(function(result, value, key) {
  result[value] = key;
}, constant(identity$2));
...
/** Used to check objects for own properties. */
var hasOwnProperty$20 = objectProto$23.hasOwnProperty;
...
var invokeMap = baseRest(function(collection, path, args) {
  ...
  baseEach(collection, function(value) {
    result[++index] = isFunc ? apply$2(path, value, args) : baseInvoke(value, path, args);
  });
  return result;
});
...
/** Used to check objects for own properties. */
var hasOwnProperty$21 = objectProto$24.hasOwnProperty;
 ...
 * // => false
 */
var lte$2 = createRelationalOperation(function(value, other) {
  return value <= other;
});
...
function max$2(array) {
  return (array && array.length)
    ? baseExtremum(array, identity$2, baseGt)
    : undefined;
}
...
function min$2(array) {
  return (array && array.length)
    ? baseExtremum(array, identity$2, baseLt)
    : undefined;
}
 ...
 * // => 24
 */
var multiply$2 = createMathOperation(function(multiplier, multiplicand) {
...
function toArray(value) {
  ...
  var tag = getTag$1(value),
      func = tag == mapTag$8 ? mapToArray : (tag == setTag$8 ? setToArray : values$2);
 ...
 * // => { 'b': '2' }
 */
var omit$2 = flatRest(function(object, paths) {
  var result = {};
  if (object == null) {
    return result;
  }
...
function omitBy(object, predicate) {
  return pickBy$2(object, negate$2(baseIteratee(predicate)));
}
...
function baseOrderBy(collection, iteratees, orders) {
  var index = -1;
  iteratees = arrayMap(iteratees.length ? iteratees : [identity$2], baseUnary(baseIteratee));
 ...
 * // => [4, 1]
 */
var over$2 = createOver(arrayMap);
 ...
 * // => 'hi fred'
 */
var partial$2 = baseRest(function(func, partials) {
  var holders = replaceHolders(partials, getHolder(partial$2));
 ...
 * // => 'hello fred'
 */
var partialRight$2 = baseRest(function(func, partials) {
  var holders = replaceHolders(partials, getHolder(partialRight$2));
 ...
 * // => objects for [['fred'], ['barney', 'pebbles']]
 */
var partition$2 = createAggregator(function(result, value, key) {
 ...
 * // => { 'a': 1, 'c': 3 }
 */
var pick$2 = flatRest(function(object, paths) {
...
function reject$2(collection, predicate) {
  var func = isArray(collection) ? arrayFilter : baseFilter;
  return func(collection, negate$2(baseIteratee(predicate, 3)));
}
...
function baseSample(collection) {
  return arraySample(values$2(collection));
}
...
function baseShuffle(collection) {
  return shuffleSelf(values$2(collection));
}
 ...
 */
var sortBy$2 = baseRest(function(collection, iteratees) {
  if (collection == null) {
    return [];
  }
 ...
 * // => 2
 */
var subtract$2 = createMathOperation(function(minuend, subtrahend) {
 ...
 * // => [2, 1]
 */
function tap$2(value, interceptor) {
  interceptor(value);
  return value;
}
...
function truncate(string, options) {
  ...
  if (isRegExp(separator)) {
    if (string.slice(end).search(separator)) {
      ...
      if (!separator.global) {
        separator = RegExp(separator.source, toString$3(reFlags$1.exec(separator)) + 'g');
      }
 ...
 */
var unionWith$2 = baseRest(function(arrays) {
  var comparator = last$2(arrays);
  comparator = typeof comparator == 'function' ? comparator : undefined;
...
function valuesIn$2(object) {
  return object == null ? [] : baseValues(object, keysIn$3(object));
}
 ...
 * // => [3]
 */
var without$2 = baseRest(function(array, values) {
  return isArrayLikeObject(array)
...
function wrap(value, wrapper) {
  return partial$2(castFunction(wrapper), value);
}
 ...
 * // => [111, 222]
 */
var zipWith$2 = baseRest(function(arrays) {
  var length = arrays.length,
...
var array = {
  chunk, compact, concat: concat$2, difference: difference$2, differenceBy,
  differenceWith: differenceWith$2, drop: drop$2, dropRight, dropRightWhile, dropWhile: dropWhile$2,
  fill, findIndex: findIndex$2, findLastIndex: findLastIndex$2, first: head$2, flatten: flatten$2,
  flattenDeep, flattenDepth, fromPairs: fromPairs$2, head: head$2, indexOf: indexOf$2,
  initial, intersection: intersection$2, intersectionBy, intersectionWith, join: join$2,
  last: last$2, lastIndexOf: lastIndexOf$2, nth: nth$2, pull, pullAll,
  pullAllBy, pullAllWith, pullAt, remove: remove$2, reverse: reverse$2,
  slice: slice$2, sortedIndex, sortedIndexBy, sortedIndexOf, sortedLastIndex,
  sortedLastIndexBy, sortedLastIndexOf, sortedUniq, sortedUniqBy, tail: tail$2,
  take: take$2, takeRight, takeRightWhile, takeWhile: takeWhile$2, union: union$2,
  unionBy, unionWith: unionWith$2, uniq: uniq$2, uniqBy: uniqBy$2, uniqWith: uniqWith$2,
  unzip, unzipWith, without: without$2, xor, xorBy,
  xorWith, zip: zip$2, zipObject, zipObjectDeep, zipWith: zipWith$2
};

var collection = {
  countBy: countBy$2, each: forEach$2, eachRight: forEachRight, every, filter: filter$2,
  find: find$2, findLast: findLast$2, flatMap, flatMapDeep, flatMapDepth,
  forEach: forEach$2, forEachRight, groupBy: groupBy$2, includes, invokeMap,
  keyBy, map: map$2, orderBy, partition: partition$2, reduce: reduce$2,
  reduceRight: reduceRight$2, reject: reject$2, sample, sampleSize, shuffle,
  size, some, sortBy: sortBy$2
};
...
var func = {
  after, ary, before, bind: bind$2, bindKey,
  curry: curry$2, curryRight, debounce, defer, delay,
  flip: flip$2, memoize: memoize$2, negate: negate$2, once: once$2, overArgs,
  partial: partial$2, partialRight: partialRight$2, rearg, rest, spread,
  throttle, unary: unary$2, wrap
};

var lang = {
  castArray, clone: clone$2, cloneDeep, cloneDeepWith, cloneWith,
  conformsTo, eq, gt: gt$2, gte: gte$2, isArguments,
  ...
  isNative, isNil: isNil$2, isNull, isNumber, isObject,
  isObjectLike, isPlainObject, isRegExp, isSafeInteger, isSet,
  isString, isSymbol, isTypedArray, isUndefined, isWeakMap,
  isWeakSet, lt: lt$2, lte: lte$2, toArray, toFinite,
  toInteger, toLength, toNumber, toPlainObject, toSafeInteger,
  toString: toString$3
};

var math = {
  add: add$2, ceil, divide: divide$2, floor, max: max$2,
  maxBy: maxBy$2, mean: mean$2, meanBy, min: min$2, minBy: minBy$2,
  multiply: multiply$2, round, subtract: subtract$2, sum: sum$2, sumBy
};

var number = {
  clamp: clamp$2, inRange, random
};

var object = {
  assign, assignIn, assignInWith, assignWith, at,
  create, defaults, defaultsDeep, entries: toPairs$2, entriesIn: toPairsIn$2,
  extend: assignIn, extendWith: assignInWith, findKey, findLastKey, forIn,
  forInRight, forOwn, forOwnRight, functions, functionsIn,
  get, has: has$2, hasIn: hasIn$2, invert: invert$2, invertBy,
  invoke, keys: keys$2, keysIn: keysIn$3, mapKeys, mapValues,
  merge: merge$2, mergeWith: mergeWith$2, omit: omit$2, omitBy, pick: pick$2,
  pickBy: pickBy$2, result, set: set$2, setWith, toPairs: toPairs$2,
  toPairsIn: toPairsIn$2, transform, unset, update: update$2, updateWith,
  values: values$2, valuesIn: valuesIn$2
};

var seq = {
  at: wrapperAt, chain: chain$2, commit: wrapperCommit, lodash, next: wrapperNext,
  plant: wrapperPlant, reverse: wrapperReverse, tap: tap$2, thru, toIterator: wrapperToIterator,
  toJSON: wrapperValue, value: wrapperValue, valueOf: wrapperValue, wrapperChain
};

var string = {
  camelCase, capitalize, deburr, endsWith: endsWith$2, escape,
  escapeRegExp, kebabCase, lowerCase, lowerFirst, pad: pad$1,
  padEnd, padStart, parseInt: parseInt$1, repeat: repeat$2, replace: replace$2,
  snakeCase, split: split$2, startCase, startsWith: startsWith$2, template,
  templateSettings, toLower: toLower$2, toUpper: toUpper$2, trim: trim$2, trimEnd,
  trimStart, truncate, unescape, upperCase, upperFirst,
  words
};

var util = {
  attempt, bindAll, cond: cond$2, conforms, constant,
  defaultTo: defaultTo$2, flow, flowRight, identity: identity$2, iteratee,
  matches, matchesProperty, method, methodOf, mixin,
  noop, nthArg: nthArg$2, over: over$2, overEvery, overSome,
  property, propertyOf, range: range$2, rangeRight, stubArray,
  stubFalse, stubObject, stubString, stubTrue, times: times$2,
  toPath, uniqueId
};
...
/** Built-in value references. */
var symIterator$2 = Symbol$1 ? Symbol$1.iterator : undefined;
...
LazyWrapper.prototype.reject = function(predicate) {
  return this.filter(negate$2(baseIteratee(predicate)));
};
...
if (symIterator$2) {
  lodash.prototype[symIterator$2] = seq.toIterator;
}
